...
The MD portfolio acts as Market 2's wild card. It has the highest average sharp ratio by a significant margin, but performs the worst in the SD and DD risk metrics. Despite it having the largest SD, the MD is on par with the best VaR. This indicates that, compared to the other portfolios, the MD earned exceptionally high returns. 
...
```{r market 3 entropy, eval=FALSE, include=FALSE, results='asis'}
