...
The empirical correlation matrix used in this study was calculated by randomly selecting the daily returns for 50 of the largest (market capitalization) 100, by market capitalization, S&P 500 stocks between 1 January 2016 and 1 January 2021. The covariance matrix was then calculated using the R package fitHeavyTail's fit_mvt function. This function uses ML estimation to fit a multivariate t-distribution to a matrix of asset returns using to the following methodology. 
