...
stocks (discussed in Section \ref{emp}) between 1 January 2020 and 1
January 2021. Maximum likelihood estimation was used to fit the
...
The average inverse HHI and entropy portfolio concentration metrics
across the five markets can be found in Tables \ref{rm1}, \ref{rm2},
\ref{rm3}, \ref{rm4} and \ref{rm5}. This section briefly touches on some
interesting trends and caveats regarding these measures.
...
\ref{rm1}). This is a large miss and can not simply be due to it being a
...
estimates (Table \ref{rm2}) are all significantly lower compared to
...
(Table \ref{rm2}). Despite its interesting concentration results, MV is
...
(Table \ref{rm2}) , indicating that they were well diversified across
...
HHI and entropy metrics in Table \ref{rm3} indicate that the MV
portfolio is the least diversified across assets and the most
diversified across sources of risk. This also holds in Market 4 (see
\ref{rm4}).
...
for holding risk. The MD has a fairly low inverse HHI, but is more
diversified than the MV across assets. Additionally, it has the highest
entropy. This suggests that it is more optimally diversified than the MV
portfolio.
...
The IV portfolio has the is tied with the EW for the lowest SD, has the
second lowest DD
