...
Metric & EW & MV & IV & ERC & MD \\ 
\hline \\[-1.8ex] 
ENC & 50 & 12.2 & 47.5 & 47.4 & 13.9 \\ 
ENB & 1.1 & 1.8 & 1.1 & 1.2 & 2 \\ 
\hline \\[-1.8ex] 
\end{tabular} 
\end{table}
...
Metric & EW & MV & IV & ERC & MD \\ 
\hline \\[-1.8ex] 
ENC & 50 & 14.6 & 47.6 & 46 & 17.8 \\ 
ENB & 1.3 & 3.7 & 1.4 & 1.5 & 2.2 \\ 
\hline \\[-1.8ex] 
\end{tabular} 
\end{table}
...
attained significant risk reduction. The IV and ERC portfolios performed
...
and ranked third best in the SD, DD and VaR metrics. It performed fairly
well from a pure risk perspective; it was only beat by the IV and ERC
portfolios. Its high Sharp ratio indicated that it was compensated well
for its risk and is therefore closer to the top right quadrant of the
efficient frontier in comparison to the ERC and IV portfolios.
...
performed similarly across the metrics in Table \ref{rm5}. The MV and MD
portfolios performed the worst. The EW dis well from a risk return
standpoint, but was out performed by the IV and ERC in terms of risk
mitigation.
